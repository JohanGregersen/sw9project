...
namespace CarDataProject {
    public static class DefaultPolicy {
        ...
        public static List<Interval> JerkIntervals = new List<Interval> { new Interval(0.001, 3),
                                                                           new Interval(3, 5),
                                                                           new Interval(5, 7),
                                                                           new Interval(7, 8),
                                                                           new Interval(8, 9),
        ...
        public static List<double> RoadTypeWeights = new List<double> { 1, 1, 1, 1.05, 1.1, 1.1, 1.2, 1.2 };
        ...
        public static List<double> AccelerationWeights = new List<double> { 1, 1, 1.075, 1.1, 1.2, 1.4, 1.6, 1.9 };
